Template.brandNameProdList.onCreated(function() {
});

Template.brandNameProdList.onRendered(function() {
	$("body").css("overflow","auto");
});

Template.brandNameProdList.helpers({
...
Template.brandNameProdList.events({
});
